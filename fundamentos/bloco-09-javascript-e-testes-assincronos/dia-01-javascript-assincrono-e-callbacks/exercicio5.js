...
//sendMarsTemperature -> recebe uma CALBECK com nome de mensagemSucesso, e a calbeck recebe as ações a serem tomadas...
const sendMarsTemperature = (mensagemSucesso) => {
    const temperaturaAtual = getMarsTemperature();
    setTimeout(() => mensagemSucesso(temperaturaAtual), messageDelay());
};
